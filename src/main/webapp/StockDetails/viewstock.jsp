...
<html>
<%@include file="stockdashboard.jsp"%>
<style>
...
<div class="banner">
    <div class="container">
        <div class="jumbotron">
            <h2>View Your Stocks Here...</h2><br><br>
            <div class="login-content">
                <form method="post" action="ViewStockServlet">
                    <div class="input-div one">
                        ...
                        <div class="div">
                            <h5 style="top: -5px; font-size: 15px;">Select SWG value of the Motor</h5>
                            <select class="form-control" id="swg" name="swg" onclick="getStockDetails(this.value)" style="border: none; position: absolute;
        left: 0;
        top: 0;
        width: 100%;
        height: 100%;
        ...
        font-family: "poppins", sans-serif;">
                    ...
                    <div class="input-div one">
                        ...
                        <div class="div">
                            <h5 style="top: -5px; font-size: 15px;">Current Stock</h5>
                            <input type="text" class="input" id="cstock" name="cstock" autocomplete="off" readonly>
                        </div>
                    </div>
                    <div class="input-div one">
                        <div class="i">
                        ...
                        <div class="div">
                            <h5>Enter Amount Of Stock used</h5>
                            <input class="input" rows="5" id="amountused" name="amountused" autocomplete="off">
                        </div>
                    </div>
