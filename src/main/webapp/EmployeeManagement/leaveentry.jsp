...
<div class="banner">
    <div class="container">
        <div class="jumbotron">
            <h2>Enter Your Employee's Leave Entry Details Here...</h2><br><br>
        ...
        font-family: "poppins", sans-serif;">
                    ...
                    <div class="input-div one">
                        ...
                        <div class="div">
                            ...
                            <input type="text" class="input" id="ename" name="ename" readonly>
                        </div>
                    </div>
                    <div class="input-div one">
                        <div class="i">
                        ...
                        <div class="div">
                            ...
                            <input type="text" class="input" id="salary" name="salary" readonly>
                        </div>
                    </div>
                    <div class="input-div one">
                        <div class="i">
                        ...
                        <div class="div">
                            <h5 style="top: -5px; font-size: 15px;">Current Salary</h5>
                            <input type="text" class="input" id="cursalary" name="cursalary" readonly>
                        </div>
                    </div>
                    <div class="input-div one">
                        <div class="i">
                        ...
                        <div class="div">
                            <h5>No Of Days</h5>
                            <input type="number" class="input" id="nodays" name="nodays" autocomplete="off" required>
                        </div>
                    </div>
